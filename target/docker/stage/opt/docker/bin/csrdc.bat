@REM csrdc launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM CSRDC_config.txt found in the CSRDC_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%CSRDC_HOME%"=="" set "CSRDC_HOME=%~dp0\\.."

set "APP_LIB_DIR=%CSRDC_HOME%\lib\"
...
set "CFG_FILE=%CSRDC_HOME%\CSRDC_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running csrdc.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !CSRDC_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
